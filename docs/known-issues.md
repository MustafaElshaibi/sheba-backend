...
| T-INT-1 | No OpenCRVS `INationalIdProvider` adapter yet (Mock + generic Http adapters exist; the second concrete registry shape is unproven) | Single civil-registry integration shape | Identity adapters |
